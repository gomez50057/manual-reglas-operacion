...
const Ficha = ({ id }) => {
  ...
  useEffect(() => {
    const handleBeforePrint = () => {
      ...
      const selectors = '.ficha_OBJETIVO, .ficha_POBLACION, .ficha_MODALIDAD, .ficha_REQUISITOS, .ficha_APOYO, .ficha_FECHA, .ficha_QR, .ficha_CONTACTO';
      ...
      const marginTop = 75;    // ajustar según necesidad
      const marginBottom = 75; // ajustar según necesidad
